...
const (
	ramdiskTLSCert     = "/mnt/ramdisk/tls/cert.pem"
	ramdiskTLSKey      = "/mnt/ramdisk/tls/key.pem"
...
func main() {
	...
	// Load attestation document (generated by boot)
	...
	cert, err := tls.LoadX509KeyPair(ramdiskTLSCert, ramdiskTLSKey)
	if err != nil {
...
func loadAttestation() (*verifier.Document, error) {
	data, err := os.ReadFile(ramdiskAttestation)
	if err != nil {
		return nil, fmt.Errorf("reading %s: %w", ramdiskAttestation, err)
	}
