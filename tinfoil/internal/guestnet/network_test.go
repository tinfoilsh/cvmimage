...
func TestValidateExternalNetwork(t *testing.T) {
	...
	for name, mutate := range map[string]func(*Config){
		...
		"mapped IPv6": func(c *Config) {
			c.Address, c.Gateway = "::ffff:100.64.0.42/120", "::ffff:100.64.0.1"
		},
		"missing prefix": func(c *Config) {
			c.Address = "100.64.0.42"
		},
		"point-to-point prefix": func(c *Config) {
			c.Address, c.Gateway = "192.0.2.0/31", "192.0.2.1"
		},
		"host prefix": func(c *Config) {
			c.Address, c.Gateway = "192.0.2.1/32", "192.0.2.1"
		},
		"subnet":    func(c *Config) { c.Gateway = "192.0.2.1" },
		"network":   func(c *Config) { c.Address = "100.64.0.0/20" },
		"broadcast": func(c *Config) { c.Address = "100.64.15.255/20" },
		"gateway":   func(c *Config) { c.Address = "100.64.0.1/20" },
		"gateway network": func(c *Config) {
			c.Gateway = "100.64.0.0"
		},
		"gateway broadcast": func(c *Config) {
